...
{
    public class ActionTrackingReportDto : BaseDtoAutoMapper<VW_ActionTrackingReport>
    {
        ...
        public static List<ColumnDefinition> GetColumnDefinitions()
        {
            ...
            {
                new ColumnDefinition("Primary Key", nameof(ActionTrackingID), ColumnType.Id),
                new ColumnDefinition("Act ID", nameof(ActionID), ColumnType.String),

                new ColumnDefinition("ACT Source", nameof(ActSource), ColumnType.String),
                new ColumnDefinition("Reference ID", nameof(ReferenceID), ColumnType.String),
